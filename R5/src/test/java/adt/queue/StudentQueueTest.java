...
public class StudentQueueTest {
	...
	@Test
	public void testHeadVazio() {
		assertEquals(null, queue3.head());
	}

	@Test
	public void testIsFull1() throws QueueOverflowException, QueueUnderflowException {
	...
	@Test
	public void testDequeue1() throws QueueOverflowException {
		assertFalse(queue1.isFull());
		queue1.enqueue(new Integer(5));
		assertTrue(queue1.isFull());
